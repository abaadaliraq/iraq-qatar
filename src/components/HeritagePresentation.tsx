...
const slides: Slide[] = [
  {
    eyebrow: "01",
    title: "مشروع إحياء الشارع التراثي في أبو نؤاس",
    subtitle:
      "مقترح لشراكة عراقية–قطرية في الحفاظ العمراني والاستثمار الثقافي والسياحي",
    body: "بغداد — أبو نؤاس",
...

  {
    ...
    body: "يقع المشروع في قلب بغداد ضمن محور يربط شارع أبو نؤاس بشارع السعدون، وفي نطاق يرتبط مباشرة بالكورنيش والفنادق ومراكز الجذب الثقافي والسياحي، ما يمنحه موقعاً مناسباً لتأسيس مشروع حضري واستثماري ذي حضور إقليمي.",
    custom: "mapImage",
    mapImage: {
  ...
  {
    eyebrow: "02 — الفرصة",
    title: "فرصة لإحياء أصل تراثي في قلب بغداد",
    body: "يمتلك الشارع موقعاً استراتيجياً بين أبو نؤاس والسعدون، ويضم مجموعة من البيوت ذات القيمة العمرانية القابلة للترميم وإعادة التوظيف. ويتيح المشروع فرصة لتحويل هذا النطاق من شارع يعاني الإهمال البصري والخدمي إلى وجهة ثقافية وسياحية واستثمارية متكاملة، من خلال نموذج تعاون عراقي–قطري يجمع بين الحفاظ على التراث والاستثمار طويل الأمد.",
    ...
    metrics: [
      ...
      { value: "فرصة استثمارية", text: "أصول تراثية قابلة للتأهيل والاستثمار" },
    ],
    variant: "opportunity",
  },
  {
    ...
    body: "يقع المشروع ضمن أحد المحاور المهمة في مركز بغداد، رابطاً بين شارع أبو نؤاس وشارع السعدون، ومقابل بوابة الدخول والخروج من الكورنيش الجديد، وعلى مقربة من مجموعة من الفنادق ونقاط الجذب القائمة. هذا الموقع يمنح المشروع قابلية حقيقية للتحول إلى وجهة يقصدها الزائر كجزء من تجربته في بغداد، ويعزز جدواه الثقافية والسياحية والاستثمارية.",
    map: {
  ...
  },
  {
    ...
    title: "المشروع يستند إلى أصول قائمة",
    body: "لا يبدأ المشروع من أرض خالية، بل من شارع قائم يضم بيوتاً ذات قيمة عمرانية، وموقعاً متصلاً بمحاور السياحة والضيافة في مركز بغداد، إضافة إلى وجود متحف بيت التحفيات كنقطة جذب ثقافية قائمة تستقطب منذ عقود الفنانين والسياح والمهتمين بالتراث. ويمنح ذلك المشروع قاعدة فعلية يمكن البناء عليها بدلاً من إنشاء وجهة جديدة من الصفر.",
    image: "/images/project/house-of-antiques.jpg",
    imagePosition: "center center",
  },
  {
    eyebrow: "08 — الرؤية المقترحة",
    title: "من شارع تراثي مهمل إلى وجهة ثقافية واستثمارية",
    subtitle: "رؤية قابلة للتنفيذ ضمن شراكة عراقية–قطرية تجمع بين الحفاظ والاستثمار.",
    image: "/images/project/heritage-houses.jpg",
    pillars: [
      {
        label: "الحفظ",
        text: "ترميم البيوت والحفاظ على العناصر المعمارية والهوية البغدادية.",
      },
      {
        label: "التشغيل",
        text: "إعادة توظيف العقارات في أنشطة ثقافية وسياحية وضيافة وتجارب نوعية.",
      },
      {
        label: "العائد",
        text: "بناء نموذج اقتصادي مستدام يولد الإيرادات وفرص العمل ويحفز استثمارات إضافية في المنطقة.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "مزيج استثماري يحول البيوت إلى وجهة متكاملة",
    ...
    closing:
      "لا يعني عدد البيوت تخصيص نشاط ثابت لكل عقار منذ البداية؛ يحدد الاستخدام النهائي بعد التقييم الإنشائي والعقاري ودراسة الجدوى، مع بناء مزيج متوازن من الأنشطة ومنع التكرار.",
    variant: "dense",
  },
  {
    ...
    body: "يتضمن المشروع برنامجاً لزيادة مشاركة المشاريع النسائية والحرفيات والفنانات والمرشدات السياحيات في الأنشطة الثقافية والتجارية والخدمية، ويمكن تطوير هذا المسار ضمن برامج المسؤولية الاجتماعية أو الشراكات التنموية المرتبطة بالمشروع، وفق مؤشرات واضحة للتشغيل والمبيعات والاستدامة.",
    custom: "women",
    variant: "women",
  },
  {
    ...
    subtitle:
      "تحويل الأصول التراثية بعد الاستحواذ والتأهيل من مبانٍ غير مستثمرة إلى منظومة ثقافية وسياحية منتجة.",
    custom: "revenue",
    variant: "revenue",
  },
  {
    ...
    subtitle:
      "أداة استرشادية لاختبار سيناريوهات الاستحواذ والترميم والتشغيل قبل استكمال التقييم العقاري ودراسة الجدوى الاستثمارية التفصيلية.",
    custom: "calculator",
    variant: "calculator",
  },
  {
    eyebrow: "14 — قابلية التوسع",
    title: "من شارع نموذجي إلى نطاق تراثي متكامل",
    body: "يمكن اعتماد الشارع كمرحلة أولى لنموذج حضري واستثماري قابل للتوسع إلى الفروع والممرات التراثية المحيطة التي تضم بدورها مباني ذات قيمة عمرانية وأصولاً غير مستثمرة. ويتيح نجاح المرحلة الأولى تطوير شبكة مترابطة من المسارات الثقافية والسياحية في مركز بغداد.",
    custom: "scalability",
    variant: "scalability",
  },
  {
    eyebrow: "15 — نموذج التملك والاستثمار",
    title: "نموذج مرن للاستحواذ والاستثمار والتشغيل",
    image: "/images/heritage-street/heritage-vision-01.jpg",
    pillars: [
      {
        label: "شراء أو استحواذ",
        text: "تمويل شراء العقارات ذات الأولوية أو اعتماد آلية قانونية مناسبة للاستحواذ عليها وفق التشريعات والإجراءات العراقية.",
      },
      {
        label: "إيجار أو انتفاع طويل الأمد",
        text: "استخدام عقود طويلة الأمد للعقارات التي يكون فيها هذا النموذج أكثر ملاءمة من الشراء المباشر.",
      },
      {
        label: "شراكة استثمار وتشغيل",
        text: "هيكلة شراكات مع مستثمرين ومشغلين متخصصين وربط العوائد بطبيعة النشاط والاستثمار.",
      },
    ],
  },
  {
    ...
    body: "يتكون العائد الاقتصادي للمشروع من قيمة الأصول بعد التأهيل إلى جانب الإيرادات التشغيلية المباشرة والنشاط السياحي والثقافي الناتج عنها. وتحدد مؤشرات العائد النهائية بعد استكمال التقييم العقاري والإنشائي ودراسة الجدوى.",
  ...
  },
  {
    ...
    title: "طبقة رقمية تربط المكان بالزائر والاستثمار",
    image: "/images/heritage-street/heritage-details-01.jpg",
    bullets: [
      "منصة رقمية للشارع مع خريطة تفاعلية.",
  ...
  },
  {
    ...
    body: "يتقدم المشروع عبر مراحل مترابطة تبدأ بالتوثيق والتقييم القانوني والعقاري والإنشائي، ثم معالجة البنية التحتية، فالاستحواذ والترميم، وصولاً إلى طرح الأصول والأنشطة للاستثمار والتشغيل.",
    timeline: [
      {
      ...
      {
        phase: "03 — الاستحواذ والترميم",
        focus: "حفظ الأصل وتهيئته لإعادة الاستخدام",
        points: [
          "استكمال إجراءات الشراء أو التعاقد للعقارات المستهدفة.",
          "ترميم العقارات ذات الأولوية.",
          "الحفاظ على العناصر المعمارية.",
          "تجهيز المباني للاستخدام الجديد.",
        ],
      },
      {
        phase: "04 — الطرح والتشغيل الاستثماري",
        focus: "تحويل الأصول إلى مشاريع منتجة",
        points: [
          "طرح الفرص الاستثمارية.",
          "اختيار المستثمرين والمشغلين.",
  ...
  },
  {
    ...
    title: "إطلاق المرحلة النموذجية دون انتظار اكتمال المشروع",
    ...
    bullets: [
      ...
      "اختيار بيتين أو ثلاثة بيوت ذات أولوية للاستحواذ والترميم.",
      "تأهيل جزء واضح ومتكامل من الشارع.",
      "إطلاق فعالية ثقافية توثق بداية التحول.",
      "طرح أولى الفرص الاستثمارية.",
    ],
    closing:
      "الهدف هو إنتاج نموذج ملموس وسريع يثبت قابلية المشروع للتنفيذ والتشغيل، ويتيح قياس تجربة الزائر والعائد قبل الانتقال إلى باقي العقارات.",
  },
  {
    ...
    pillars: [
      ...
      {
        label: "الإطلاق",
        text: "أسبوع ثقافي وفني، سوق للحرف والأنتيك، جولات مرشدة، فعاليات وتجارب بالتعاون مع القطاع السياحي.",
      },
      {
        label: "بعد الافتتاح",
  ...
  {
  eyebrow: "23 — الخاتمة",
  title: "من إحياء شارع إلى بناء نموذج جديد للتعاون الثقافي والاستثماري",
  body: "يجمع الشارع التراثي في أبو نؤاس عناصر نادرة داخل نطاق واحد: موقع في قلب بغداد، بيوت ذات قيمة عمرانية، اتصال بالكورنيش والفنادق، نشاط ثقافي قائم، وفرصة واضحة لإعادة التأهيل والاستثمار.\n\nويمكن من خلال شراكة عراقية–قطرية تحويل هذه العناصر إلى مشروع حضري متكامل يحفظ الذاكرة البغدادية، يعيد توظيف الأصول التراثية، ويخلق وجهة ثقافية وسياحية واستثمارية ذات أثر اقتصادي طويل الأمد.",
  image: "/images/project/house-of-antiques.jpg",
    ...
    <div className="custom-flow women-flow">
      ...
      <div className="women-bottom-grid">
        ...
        >
          ...
          <p>
            يمكن تطوير هذا المسار بالتعاون مع مؤسسة عراقية أو قطرية متخصصة في
            التمكين والتنمية، لتمويل التدريب والتجهيز وتطوير المشاريع وقياس أثر
            البرنامج.
          </p>
        </motion.article>
...
const heroContacts = [
  ...
  },
  {
    ...
    icon: Globe,
    label: "Website",
    value: "www.abaad-aliraq.com",
  },
  {
    href: "https://wa.me/9647770350030",
    icon: MessageCircle,
    label: "WhatsApp",
    value: "+9647770350030",
  },
  {
    ...
    icon: Mail,
    label: "Email",
    value: "abaadaliraq07@gmail.com",
  },
];

function HeroIntro() {
  return (
    <div className="hero-intro" aria-label={"\u0623\u0628\u0639\u0627\u062f \u0627\u0644\u0639\u0631\u0627\u0642"}>
      <Image
        ...
        width={2000}
      />
      <p className="hero-credit">{"\u062a\u0645 \u062a\u0635\u0645\u064a\u0645 \u0627\u0644\u0639\u0631\u0636 \u0627\u0644\u062a\u0642\u062f\u064a\u0645\u064a \u0628\u0648\u0627\u0633\u0637\u0629 \u0627\u0628\u0639\u0627\u062f \u0627\u0644\u0639\u0631\u0627\u0642"}</p>
      <aside className="hero-contact-rail" aria-label={"\u0644\u062a\u0648\u0627\u0635\u0644"}>
        <strong>{"\u0644\u062a\u0648\u0627\u0635\u0644"}</strong>
        <div>
